...
public class NumMcq6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_num_mcq6);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),num_set6.class));
    ...
    public void Q1(){
        ...
        question.setText("What is the sign for '1000'?");
        ...
        Uri uri1 = Uri.parse("https://firebasestorage.googleapis.com/v0/b/signswift-7c7cc.appspot.com/o/Numbers%2F29.mp4?alt=media&token=693418da-cdff-43bf-b5d6-e402b17ece46");
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!option2.isSelected() && !option1.isSelected()) {
                    ...
                    Toast.makeText(NumMcq6.this, "Please!! select atleast 1 option", Toast.LENGTH_SHORT).show();
                }
                if (option1.isSelected()) {
                    ...
                    option1.setSelected(false);
                    option2.setSelected(false);
                    Toast.makeText(NumMcq6.this, "Correct Answer", Toast.LENGTH_SHORT).show();
                }
                if (option2.isSelected()) {
                    option1.setSelected(false);
                    option2.setSelected(false);
                    Toast.makeText(NumMcq6.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
                }
    ...
    public void Q2() {
        ...
        question.setText("The sign for 'Billion' is?");
        ...
        Uri uri1 = Uri.parse("https://firebasestorage.googleapis.com/v0/b/signswift-7c7cc.appspot.com/o/Numbers%2FBillion.mp4?alt=media&token=9f517ccb-ca65-4956-9b80-f0553e14fac6");
        video2.setVideoURI(uri1);
        video2.requestFocus();
        video2.start();
    ...
    public void Q3() {
        ...
        question.setText("The sign for '100' is?");
        ...
        Uri uri1 = Uri.parse("https://firebasestorage.googleapis.com/v0/b/signswift-7c7cc.appspot.com/o/Numbers%2FHundred.mp4?alt=media&token=c26f6984-2a9e-4b0f-b801-767f804e4280");
        video2.setVideoURI(uri1);//100
        video2.requestFocus();
        video2.start();
